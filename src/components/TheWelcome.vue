...
<template>
  ...
  <WelcomeItem>
    ...
    <a
      ...
      rel="noopener"
      >Volar</a
    >. If you need to test your components and web pages, check
    out
  ...
  <WelcomeItem>
    ...
    As an independent project, Vue relies on community backing
    for its sustainability. You can help us by
    <a
